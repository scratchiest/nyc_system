...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2019 at 02:16 AM
...
INSERT INTO `users` (`user_id`, `firstname`, `lastname`, `contactno`, `username`, `password`, `accesstype`) VALUES
(1, 'Warren', 'Rezane', '09667591163', 'warshock10', '9538ab335d530f2ebde37a4b32dc396ee5eee758', '2'),
(2, 'Warren', 'Rezane', '09078215066', 'nyc_warren', 'fa7d28fdb790db8bfc8c021045e9ba4e0b4d28ef', '1'),
(3, 'Jaime', 'Pinili', '09078215066', 'cescon_jaime', '6b5edde567f4f29018862811195dbd14b8addd2a', '1');
...
--
ALTER TABLE `campers`
  MODIFY `camper_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=465;
